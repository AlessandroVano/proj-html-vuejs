      ...
      <div class="row  ">
        <div class="col-5   ">
          <img src="../assets/medical_logo_1x_dark.png" alt="">
           ...
           <p >nventore veritatis et quasi architecto beatae luptatem accusantium.</p> 
             <div class="separator">____________________________________________________________</div>
           <h5>LEARN MORE ABOUT US</h5>
                 <i class="fab fa-facebook-f  mt-4 mb-5  i_1"></i>
             <i class="fab fa-twitter i_2"></i>
             <i class="fab fa-youtube i_4"></i>
        ...
        <div class="col-3">
          ...
          <ul>
            <li>
              <i class="fas fa-chevron-right me-1 chevr"></i>
              cardiology
            </li>
            <li>
              <i class="fas fa-chevron-right me-1 chevr"></i>
          ...
          <button class="btn_1 mt-3"> <h5 class="pt-2">view our department</h5> </button>
        </div>
      </div>
    </div>
  </section>
